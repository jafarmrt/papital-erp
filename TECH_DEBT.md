...
*آخرین بازبینی: v3.0.8 — اجرای فاز ۳ ممیزی جنایی V3: رفع TD-058 و TD-059 (Dockerfile، PVC/uploads، گیت docker در CI، اعتبارسنجی pg_dump و drill بازیابی موفق). باقی‌مانده: TD-055/063/067 (فاز ۴ — پاکسازی تست‌های tautological و ReleaseGate و دو تست pre-existing). مسئولیت به‌روزرسانی: هر AI Agent / دولوپر قبل از پایان هر زیرفاز.*
