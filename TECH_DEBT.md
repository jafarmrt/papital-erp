...
*آخرین بازبینی: v3.1.0 — بهبود کنترل پروژه: پیشرفت ماتریسی SKU×مرحله (TD-069)، رفع نمایش عنوان پروژه به‌جای کد کالا، حذف داده جعلی و باگ ریست تب. بدهی عمدی باقی‌مانده: TD-070 (پل خرید و اتصال سند←پروژه — بخش بعدی نرم‌افزاری). مسئولیت به‌روزرسانی: هر AI Agent / دولوپر قبل از پایان هر زیرفاز.*
