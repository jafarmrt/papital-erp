...
import {
  ...
  PlusCircle, FileText, Layers, Sparkles
} from 'lucide-react';
...
export default function Dashboard() {
  ...
  // V10-3.3: نمودار گردش ماهانه و ویجت‌های تند/کند/راکد به صفحه «تحلیل گردش کالا و هشدار تامین» منتقل شدند
  ...
  return (
    <div className="space-y-6 pb-8">
      {/* Top Banner Header */}
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center bg-white p-5 border rounded-2xl shadow-xs gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-extrabold text-slate-800">پیشخوان مدیریت و هوش تجاری انبار</h1>
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-3.5 rounded-2xl shadow-sm text-white flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-xs font-bold text-slate-300">
          <span>⚡ میانبرهای عملیاتی سریع:</span>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Section: Multi-Location stocks — V10-3.3: نمودار گردش به صفحه تحلیل گردش منتقل شد */}
          <div>
