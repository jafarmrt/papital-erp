...
const CRITICAL_SCENARIO_TITLES: Record<CriticalScenarioId, string> = {
  ...
  v4_test_cleanup_marker_only_guard: 'Data Safety: Test Cleanup Marker-Only Redesign (TD-107)',
  v4_project_reservation_release_guard: 'Inventory: Single-Path Project Reservation Release with OCC & Audit (TD-081)',
