      ...
      <div>
        ...
        <div className={`rounded-xl border p-4 space-y-3 transition-colors ${testEndpointsOn ? 'bg-amber-50/60 border-amber-300' : 'bg-slate-50/60 border-slate-200'}`}>
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            کنترل دسترسی به دو مسیر <span className="font-mono" dir="ltr">GET /api/system/tests/run</span> و <span className="font-mono" dir="ltr">POST /api/system/clean-test-data</span> که مجموعه آزمون‌های یکپارچگی (فاز ۲۱) را اجرا می‌کنند. فقط نقش مدیر (admin) به این مسیرها دسترسی دارد.
          </p>
